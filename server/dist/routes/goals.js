...
import { listGoals, getGoal, createGoal, updateGoal, deleteGoal, updateProgress, goalCreateSchema, goalUpdateSchema, goalProgressSchema, } from '../services/goalService.js';
...
goalsRouter.patch('/:id', validate(idParam, 'params'), validate(goalUpdateSchema), (req, res) => {
    const { id } = validated(req, 'params');
...
goalsRouter.post('/:id/progress', validate(idParam, 'params'), validate(goalProgressSchema), (req, res) => {
    const { id } = validated(req, 'params');
