...
import { listReminders, getReminder, createReminder, updateReminder, deleteReminder, reminderCreateSchema, reminderUpdateSchema, } from '../services/reminderService.js';
...
remindersRouter.patch('/:id', validate(idParam, 'params'), validate(reminderUpdateSchema), (req, res) => {
    const { id } = validated(req, 'params');
