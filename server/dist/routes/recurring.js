...
import { createRecurring, listRecurring, getRecurring, updateRecurring, deleteRecurring, runRecurring, recurringCreateSchema, recurringUpdateSchema, } from '../services/recurringService.js';
...
recurringRouter.patch('/:id', validate(idParam, 'params'), validate(recurringUpdateSchema), (req, res) => {
    const { id } = validated(req, 'params');
